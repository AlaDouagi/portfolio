    ...
    >
      <div className="mx-auto flex min-h-screen max-w-5xl flex-col items-center justify-center px-10 py-24 text-4xl font-semibold tracking-tight md:py-28 md:text-6xl lg:px-20 lg:py-3 lg:text-7xl">
        <div className="leading-[1.15]">
          ...
          >
            I leverage my passion and expertise to create innovative digital products and immersive
            experiences.
          </span>
          <span
          ...
          >
            My enthusiasm lies in exploring the latest advancements in JavaScript technologies and
            seamlessly integrating UI design systems.
          </span>
        </div>
      </div>
    </div>
